...
do
	cd results_all/get_methylation/alignment/
	ls | while read sample
	do
		cd $sample/modkit_beds/
...
cp ../../get_read_summary_hybrids_from_bed_v3.sh .
bash get_read_summary_hybrids_from_bed_v3.sh ../../$ref ../../$annotation
cd ../../
